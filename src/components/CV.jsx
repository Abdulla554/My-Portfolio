    ...
    <>
      ...
      <div className="mt-16 flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-14 mb-2">
          <Tilt glareEnable={true} glareMaxOpacity={0.15} scale={1.04} tiltMaxAngleX={12} tiltMaxAngleY={12} className="">
            <motion.a
              href="mailto:abdulla33alsaad8@gmail.com"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.2 }}
              whileHover={{ scale: 1.05, boxShadow: '0 4px 24px 0 rgba(0,0,0,0.15)', background: 'linear-gradient(to right, var(--tw-gradient-stops))', filter: 'brightness(1.1)' }}
